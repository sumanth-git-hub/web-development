...
export default function ExpenseTable({ getExpenses, prepareExpenses }) {
  ...
  const totalCount = result.reduce((accumulator, current) => accumulator + Number(current.amount), 0)
  ...
  return (
    <>
    <ContextMenu menuPosition={styleMenu} setMenuPosition={setStyleMenu} setData={prepareExpenses} passId = {rowId}/>
