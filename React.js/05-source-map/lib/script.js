const contentSection = /*#__PURE__*/React.createElement("p", {
  style: {
    marginTop: '10px'
  }
}, "A source map in React (or any JavaScript project) is a file that maps your minified or compiled code back to the original source code, like JSX or ES6.");
const appendContent = ReactDOM.createRoot(document.querySelector('.content-section'));
appendContent.render(contentSection);
