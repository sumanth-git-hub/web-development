          ...
          <th className="amount-column">
            <div>
              ...
              <svg
                ...
                onClick={(e) => {
                  // e.stopPropagation()
                  // prepareExpenses((prevState) => [...prevState.sort((a,b) => a.amount - b.amount)])
                  setSortCallBack(() => (a,b) => a.amount - b.amount) // other way to add the sort function through state
              ...
              <svg
                ...
                onClick={(e) => {
                  // e.stopPropagation()
                  // prepareExpenses((prevState) => [...prevState.sort((a,b) => b.amount - a.amount)])
