            ...
            >
              ...
              {plan.mostPopular && (
                <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="flex items-center space-x-1 px-3 sm:px-4 py-1 sm:py-1.5 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full text-xs sm:text-sm font-semibold shadow-lg gap-1">
                    <i className="fa-regular fa-star w-3 h-3 sm:w-3 sm:h-3 fill-white"></i>
                ...
                {plan.features.map((feature, featureKey) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-blue-500/20 flex items-center justify-center mt-0.5">
                      <i className="fa-solid fa-check w-2.5 h-2.5 sm:w-3 sm:h-3 text-blue-400"></i>
                    </div>
