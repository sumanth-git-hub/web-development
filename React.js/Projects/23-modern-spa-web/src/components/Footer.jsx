          ...
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              ...
              >
                ...
                <i className="fa-brands fa-x-twitter w-5 h-5 sm:w-5 sm:h-5"></i>
              </a>
              <a
                href="#"
                className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
                ...
                <i className="fa-brands fa-github w-5 h-5 sm:w-5 sm:h-5"></i>
              </a>
              <a
                href="#"
                className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
                ...
                <i className="fa-brands fa-linkedin w-5 h-5 sm:w-5 sm:h-5"></i>
              </a>
              <a
                href="#"
                className="p-2 sm:p-2.5 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors duration-200"
              >
                ...
                <i className="fa-regular fa-envelope w-5 h-5 sm:w-5 sm:h-5"></i>
              </a>
            </div>
          </div>
