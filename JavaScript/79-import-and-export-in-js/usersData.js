...
const usersData = [
        ...
        const getCarDetails = {
           ...
           export function carOwner() {
                return getCarDetails.carOwner
            }
            // console.log(carOwner())

        export { usersData }  // all about named export
        
        export default getCarDetails  // all about default export, only one default export we can do in one document