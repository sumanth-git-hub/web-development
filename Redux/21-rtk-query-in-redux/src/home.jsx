...
export default function Home() {
  ...
  // const {data: tasksList, isLoading, isError, error, refetch} = useGetTasksQuery()
 ...
 const [updateTask] = useUpdateTaskMutation()
  ...
  return (
    <div className="flex h-screen items-start justify-center bg-gray-900 p-4">
      <div className="task-app w-full max-w-md rounded-lg bg-gray-800 px-6 pb-2 pt-6 text-gray-200 shadow-lg">
        ...
        >
          ...
          <input
            className="ml-4 h-8 w-full bg-transparent font-medium focus:outline-none"
            type="text"
        ...
        <div className="tasks-container overflow-auto">
          {isLoading ? (
            ...
            // [...tasksList].reverse().map((task) => ( // reverse the array items
              tasksList.map((task) => (
              <TaskItem
                key={task.id}
                task={task}
